...
import test.integration.jaxb.bookstore.services.CustomerTest;
import test.integration.jaxb.bookstore.services.CustomerTestImpl;
...
public class CustomerJaxBTest {
	...
	@Before
	public void publishCustomerTestEndpoint() {
